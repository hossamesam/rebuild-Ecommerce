                ...
                <div className="flex gap-8">
                    ...
                    <Box className="w-full">
                            ...
                            {data.map((res) => {
                                return (
                                    <Tshirt
                                        key={res.id}
                                        id={res.id}
                                        src={"https://img4.dhresource.com/webp/m/0x0/f3/albu/km/y/27/96e16fa8-e958-4bf7-a0f6-05827e1ce65c.jpg"}
                                        alt={res.description}
                                        href={"#"}
                                        name={res.nameAr}
                                        color={res.colors}
                        ...
                        <div className="flex justify-center items-center  w-full my-20 ">
                            <PaginationUi router={router} count={PaginationNum}></PaginationUi>
                        </div>
                    </Box>
