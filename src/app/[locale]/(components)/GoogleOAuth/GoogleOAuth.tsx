...
function GoogleOAuth() {
    ...
    const responseGoogle = process.env.NEXT_PUBLIC_google_id_client_OAuth
    ...
    return (
        <div className='w-full  bg-slate-50 flex justify-center items-center'>
            ...
            <GoogleOAuthProvider clientId={"568500689470-p22ceulaflu8v22e5hovl7u03bvh49g1.apps.googleusercontent.com"}>
                <GoogleLogin
                    size='large'
                    text='signin_with'
                    onSuccess={(credentialResponse) => {
            ...
            {/* <div className="w-full lg:w-1/1 mb-2 lg:mb-0" onClick={() => login()}>
