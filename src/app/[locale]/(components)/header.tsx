  ...
  return (
    <>
      <header className="h-24 max-sm:h-12 bg-neutral-950 flex flex-row items-center justify-between dark:bg-red-500">
        ...
        <div id='search' className="flex max-sm:hidden  justify-center items-center pt-2  grow  relative mx-auto text-gray-600">
        ...
        <nav id='log-in_And_buy' className=' flex flex-row items-center justify-center   ml-4 mt-2 gap-2'>
          ...
          <button className='flex  items-center justify-center flex-row gap-2 max-sm:h-10 max-sm:w-10 max-sm:bg-slate-500 max-sm:rounded-full max-sm:hover:bg-slate-600 hover:scale-105 hover:border-[1px] rounded p-1' >
            ...
            <div className="text-2xl max-sm:hidden sm:whitespace-nowrap sm:text-[20px]  font-bold text-white font-['Roboto'] ">{props.ShoppingCar}</div>
          </button>
        ...
        <div className={state_menu + '  bg-gray-900/45  absolute h-full w-full  top-0 z-20 '}>

          <button type='submit' onClick={close_menu} className=' h-full w-5/6' />
          ...
          <div className='bg-slate-50 text-black absolute h-full w-80 right-0 border-2  '>
            ...
            <div className=' py-4 px-5 gap-8 flex flex-col '>
              ...
              <a href="/" type='submit' className='flex gap-4 flex-row  hover:bg-gray-100 hover:scale-110  '>
                ...
                <div className="text-2xl font-bold text-black font-['Roboto'] ">{props.signIn}</div>
              </a>

              <a href="/" className='flex flex-row gap-4 hover:bg-gray-100 hover:scale-110' >
                <ShoppingCart color='black' size={30} />
                <div className="text-2xl font-bold text-black font-['Roboto'] ">{props.ShoppingCar}</div>
              </a>
            ...
            <div className=' py-4 px-5 gap-8 flex flex-col'>
              ...
              <a href="/" className='flex flex-row gap-2 text-black items-center  w-full hover:bg-gray-100 hover:scale-110 '>
                ...
                <h6 className="text-2xl font-bold text-black font-['Roboto'] ">{props.mens}</h6>
              </a>
              <a href="/" className='flex flex-row gap-2 text-black items-center  w-full hover:bg-gray-100 hover:scale-110 '>
                ...
                <h6 className="text-2xl font-bold text-black font-['Roboto'] ">{props.women}</h6>
              </a>
              ...
              <a href="/" className='flex flex-row gap-2 text-black items-center  w-full hover:bg-gray-100 hover:scale-110 '>
                ...
                <h6 className="text-2xl font-bold text-black font-['Roboto'] ">{props.baby}</h6>
              </a>
              <a href="/" className='flex flex-row gap-2 text-black items-center  w-full hover:bg-gray-100 hover:scale-110 '>
                ...
                <h6 className="text-2xl font-bold text-black font-['Roboto'] ">{props.shoes}</h6>
              </a>
            </div>
          </div>
