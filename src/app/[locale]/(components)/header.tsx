    ...
    <div  className=" bg-teal-400">
      ...
      <header className="h-24   max-sm:h-12 bg-neutral-950 flex flex-row items-center justify-between dark:bg-red-500">
        ...
        >
          ...
          <button onClick={close_menu_Shop} className="flex  items-center justify-center flex-row gap-2 max-sm:h-10 max-sm:w-10 max-sm:bg-slate-500 max-sm:rounded-full max-sm:hover:bg-slate-600 hover:scale-105 hover:border-[1px] rounded p-1">
            <svg
              width="24"
              viewBox="0 0 24 24"
              fill="none"
