      ...
      <div className="flex h-screen  " dir='ltr'>
        ...
        <div className="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
          <div className="max-w-md text-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="524.67004" height="531.39694" className="w-full" xlinkTitle="https://undraw.co/illustrations" viewBox="0 0 524.67004 531.39694" xmlnsXlink="http://www.w3.org/1999/xlink">
          ...
          <div className="max-w-md w-full p-6">
            ...
            >
              ...
              <button
                ...
                className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300 hover:cursor-pointer"
              >
                {props.signUp}
              </button>
...
// const [registers, setregisters] = useState<signup>();
// useEffect(() => {
//   // http://localhost:8001/api/ahmed123456789
//   // https://tarmeezacademy.com/api/v1//logout
//   axios.post("http://localhost:8001/api/registers", registers)
